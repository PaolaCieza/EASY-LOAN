...
<body class=" ">
    <nav class="navbar navbar-dark  navbar-expand-lg  navbar-light fixed-top " style="background-color: black; ">
        ...
        <div class="collapse navbar-collapse " id="navbarSupportedContent">
            <ul class="navbar-nav mr-auto">
                ...
                <li class="nav-item active">
                    <a class="nav-link nav-a" href="prestamista.php">PRESTAMISTA <span
    ...
    <section class="container-fluid">
        <div class="-sobre-nosotros-parte1  container-fluid p-0 m-0">
            <div class="row fondoprueba  "> 
                <div class="row  offset-4 mt-1 justify-content-center">
                    <p  style="text-decoration: none;" class="mt-1 ml-2 xd text-white font-italic font-weight-light"> <b class="font-weight-bold">HOLA</b>, SOMOS EASY LOAN, AQUÍ PODRÁS  CONOCERNOS MEJOR</h1>
                </div>
            </div>
        </div>
        <div class="container-fluid">
            <div class="row  justify-content-center ">
                <h1 class="text-warning mt-5 text-index-titulo"> SOBRE NOSOTROS</h1>
            </div>
                ...
                <div class="row mt-4">
                    <div class="col-sm contenedor-sobre-nosotros" onclick="location.href='historia.php'">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">HISTORIA</span>
                        </div>
                    </div>
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            <div>
                                <span class="icono-sobre-nosotros"> f</span>
                            </div>
                            <span class="tex-contenedor-sobre-nosotros">CONTRATOS</span>
                        </div>
                    </div>
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">TRANSPARENCIA</span>
                        </div>
                    </div>
                </div>
                <div class="row mt-4">
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">WBDS</span>
                        </div>
                    </div>
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">VISIÓN</span>
                        </div>
                    </div>
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">CALIDAD</span>
                        </div>
                    </div>
                </div>
                <div class="row mt-4 mb-5">
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">SEGURIDAD</span>
                        </div>
                    </div>
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">OBJETIVOS</span>
                        </div>
                    </div>
                    <div class="col-sm contenedor-sobre-nosotros">
                        <div class="row div-contenedor-icono">
                            ...
                            <span class="tex-contenedor-sobre-nosotros">GARANTÍA</span>
                        </div>
                    </div>
                </div>
            </div>
