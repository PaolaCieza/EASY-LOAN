          ...
          <center> <a href="../index.html"><img src="../recursos/iconfinder_Facebook-1_669610.png" alt=""></a> </center>
            ...
            <form id="frmuser">     
              <div class="from-group">
                <label class="text-capitalize" for="txtusuario">USUARIO</label>
                <input input type="text" style="display: none;" disabled="disabled" size="1">
                <input class="form-control" type="text"  id="txtusuario" placeholder="Ingrese su usuario aquí...." onkeypress = "if(event.keyCode == 13) iniciarSesion(0)"> <br>
                <div style="border-top: 1px solid#888; padding-top:15px; font-size:85%" ></div>
              </div>
              <button type="button" class="btn btn-warning" onclick="iniciarSesion(0)" id="btn_envio" >SIGUIENTE</button>
              <br>
            </form>
          </div>
