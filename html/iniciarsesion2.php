<?php
session_start();
if(!isset($_SESSION['usuario'])) header("location: iniciarsesion.php");
?>
<!DOCTYPE html>
<html lang="es">
...
<body class="bg-light">
  <!-- <nav class="navbar navbar-dark  navbar-expand-lg  navbar-light   " style="background-color: black;">
    ...
    <button class="navbar-toggler" type="button" data-toggle="collapse" 
      ...
      <a href="registrarse.html" id="estesi"> <button class="btn btn-warning">REGISTRAR</button></a>
  </nav> -->
          ...
          <div class="col-md-4 col-sm-6 col-md-offset-3 col-sm-offset-3 inicio-fondo">
                ...
                <form>
                  <div class="from group">
                      <label class="text-capitalize" for="txtcontraseña">CONTRASEÑA</label>
    ...
    <br>
    <footer class="page-footer font-small unique-color-dark fixed-bottom" style="background-color: black;  color: white; ">
        ...
        <!-- <div class="container text-center text-md-left mt-5" style="background-color: black;">
          ...
          <div class="row mt-3">
            ...
            <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
              ...
              <p class="footer-color">Compañía encargada de brindar servicios de prestamos entre personas con ubicación similar.</p>
            ...
            <div class="col-md-3 col-lg-2 col-xl-2 mx-auto mb-4" >
              ...
              <hr class=" mb-4 mt-0 d-inline-block mx-auto" style="width: 60px; background-color: #7c4dff;">
              <p>
                <a style=" color: white; " href="https://www.cuidatudinero.com/13182374/ventajas-y-desventajas-de-invertir">Ventajas y desventajas de invertir</a>
              </p>
              <p>
                <a style=" color: white; " href="https://caisaagenciadebolsa.com/articulo/invierte-bolsa-ya/1-los-beneficios-invertir/">Los beneficios de invertir</a>
              </p>
              <p>
                <a style=" color: white; " href="https://www.iahorro.com/ahorro/noticias/ventajas_y_desventajas_de_los_prestamos_personales.html">Préstamos personales</a>
              </p>
              <p>
                <a style=" color: white; " href="https://www.monografias.com/trabajos97/beneficios-prestamos/beneficios-prestamos.shtml">Beneficios de los préstamos</a>
              </p>
